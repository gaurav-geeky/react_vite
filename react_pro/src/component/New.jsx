...
import im1 from '../assets/cloth/w3.png'
import im2 from '../assets/cloth/w4.png'
import im3 from '../assets/cloth/w5.png'
import im4 from '../assets/cloth/m3.png'
import im5 from '../assets/cloth/m4.png'
import im6 from '../assets/cloth/m5.png'
...
function New() {
  ...
  let ProductList = [
    { pid: 1, pname: "Elichie t-shirt ", pimg: im1, pprice: 350.00 },

    { pid: 2, pname: "skyblue t-shirt", pimg: im2, pprice: 411.00 },

    { pid: 3, pname: "latest t-shirt", pimg: im3, pprice: 500.00 },

    { pid: 4, pname: "white t-shirt", pimg: im4, pprice: 450.00 },

    { pid: 5, pname: "tommy hilfiger t-shirt", pimg: im5, pprice: 350.00 },

    { pid: 6, pname: "latest t-shirt", pimg: im6, pprice: 350.00 },
